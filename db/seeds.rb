...
user_normal = User.create(email: "mperezzevallos+regular@gmail.com", name:'lucas', password:'regular', role:'regular')
user_normal2 = User.create(email: "p+regular@gmail.com", name:'lucas', password:'regular', role:'regular')
user_normal_1 = User.create(email: "mperezzevallos+regular1@gmail.com", name:'Cris', password:'regular', role:'regular')
user_normal_2 = User.create(email: "mperezzevallos+regular2@gmail.com", name:'Juan', password:'regular', role:'regular')
...
user_normal_1.bookings.create(start_date: Date.parse('01-05-2019'), end_date: Date.parse('05-03-2019'), paid_price: 20, room_id: 2)
user_normal_2.bookings.create(start_date: Date.parse('01-05-2019'), end_date: Date.parse('05-03-2019'), paid_price: 20, room_id: 3)
